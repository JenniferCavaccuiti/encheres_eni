...
<div class="row justify-content-center">
    <div class="col-5">
        <form action="${pageContext.request.contextPath}/nouvelle-vente" method="post" novalidate
            ...
            <div class="form-group row">
                <div class="col-5">
                    <label for="category" class="col-4">Catégorie :</label>
                </div>
                <div class="col-7">
            ...
            <c:if test="${empty item.bidsStartDate}">
                ...
                <br>
                <div class="form-group row">
                    <label for="bidsEndDate" class="col-5">Fin de l'enchère :</label>
                    <div class="col-4">
            ...
            <c:if test="${not empty item.bidsStartDate}">
                <div class="form-group row">
                    <label for="bidsStartDate2" class="col-5">Début de l'enchère :</label>
                    <div class="col-4">
                ...
                <br>
                <div class="form-group row">
                    <label for="bidsEndDate2" class="col-5">Fin de l'enchère :</label>
                    <div class="col-4">
            ...
            <br>
            <c:if test="${not empty item}">
                <button class="btn btn-primary" type="submit" name="submitType" value="update">Valider</button>
